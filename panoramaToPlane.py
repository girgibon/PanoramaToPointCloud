...
out = cv2.VideoWriter('output1.mp4', fourcc, 30.0, (960, 960))
for deg in tqdm(np.arange(0, 360, 0.5)):
    output_image = panorama_to_plane(
        r"C:\Users\shadr\Downloads\TestTaskSFM\TestTaskSFM\sphere_sfm\frame0000250.jpg",
        90, (960, 960), deg, 90)
